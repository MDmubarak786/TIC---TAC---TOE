            ...
            child: IconButton(
              ...
              onPressed: () {
                AlertDialog alertDialog = AlertDialog(
                  ...
                  content: Text(
                    "Tic-Tac-Toe Version-2.0.Thanks for playing this game.For any help or feedback, contact the developer at 'mohammedmubarakmk@gmail.com' ",
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.fromLTRB(140, 0, 10, 10),
                child: Center(
                  child: img0(),
                ),
              ),
